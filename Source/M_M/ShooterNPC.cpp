...
void AShooterNPC::Die()
{
	...
	// Tell GameMode to start escape timer
	if (AShooterGameMode* GM = Cast<AShooterGameMode>(
...
{
	AShooterCharacter* PlayerCharacter = Cast<AShooterCharacter>(ActorToShoot);

	// Checks if the player has a weapon
	if (PlayerCharacter && !PlayerCharacter->HasWeapon())
	{
